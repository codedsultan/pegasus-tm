			...
			<div className="dropdown float-right h-4">
				<PopoverLayout toggler={<PopoverToggle />} placement="bottom-end" togglerClass="text-gray-600 dark:text-gray-400">
					<div className="min-w-40 z-50 transition-all duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-600 rounded-md py-1">
						<Link className="flex items-center py-1.5 px-4 text-sm text-gray-500 hover:bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300" href="">
						...
						<Link className="flex items-center py-1.5 px-4 text-sm text-danger hover:bg-slate-100 dark:hover:bg-gray-700" href="">
								...
								<div className="p-1.5">
									<div className="flex justify-between items-center">
										<div className="flex items-center gap-3">
											...
											<div className="">
												<Link href="" className="text-sm text-gray-400 font-bold">
													{file.filename}
												</Link>
										...
										<div className="w-auto float-right" id="tooltip-container9">
											...
											<Link href="" className="text-xl text-danger">
								...
								<form action="#" className="">
									...
									<div className="p-2 bg-gray-400/10 dark:">
										<div className="flex items-center gap-2">
											<Link href="#" className="btn btn-sm bg-light dark:bg-gray-600 text-gray-950 dark:text-white">
